...
class StrukturController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.admin.struktur-pemerintahan', compact('desktop', 'mobile'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->all();
        if ($request->tipe == 'desktop') {
            $data['gambar'] = $request->file('gambar')->store(
                'aset/struktur-pemerintahan/desktop', 'public'
            );
        } else {
            $data['gambar'] = $request->file('gambar')->store(
                'aset/struktur-pemerintahan/mobile', 'public'
            );
        }
