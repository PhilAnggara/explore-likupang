        ...
        <div class="card shadow">
          <div class="card-body">
            ...
            <p class="nama-desa mt-4 text-justify">
              ...
              <span class="row">
                <span class="col-sm-2 col-5">Sebelah Utara</span>
                <span class="col-1"> : </span>
                <span class="col-sm-9 col-12">&emsp;Laut Sulawesi dan Sangihe Talaud</span>
              </span>
              <span class="row">
                <span class="col-sm-2 col-5">Sebelah Timur</span>
                <span class="col-1"> : </span>
                <span class="col-sm-9 col-12">&emsp;Kota Bitung</span>
              </span>
              <span class="row">
                <span class="col-sm-2 col-5">Sebelah Selatan</span>
                <span class="col-1"> : </span>
                <span class="col-sm-9 col-12">&emsp;Kecamatan Likupang Selatan</span>
              </span>
              <span class="row">
                <span class="col-sm-2 col-5">Sebelah Barat</span>
                <span class="col-1"> : </span>
